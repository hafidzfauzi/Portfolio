...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 w-full text-white z-[9999] transition-all duration-300 overflow-visible ${
        isScrolled || isOpen
    ...
    >
      ...
      <div
        className={`lg:hidden absolute top-full left-0 w-full bg-black/95 transition-all duration-300 overflow-hidden ${
